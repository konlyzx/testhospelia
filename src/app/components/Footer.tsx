        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center">
             <img src="/img/logo-hospelia.webp" alt="Hospelia" className="w-44" />
            </div>
            <p className="mt-4 text-gray-400 text-sm">
              Encuentra el alojamiento perfecto para tus vacaciones o comparte tu espacio y conviértete en anfitrión.
            </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-4">
              <p className="text-gray-400 text-sm">
                &copy; {currentYear} <Link href="/" className="text-white hover:text-gray-300">Hospelia</Link>. Todos los derechos reservados.
              </p>
