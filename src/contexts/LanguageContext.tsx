...
const translations = {
  es: {
    ...
    'footer.discover': 'Descubre',
    'footer.lodgings': 'Alojamientos',
    'footer.experiences': 'Experiencias',
    'footer.zones': 'Zonas donde operamos',
    'footer.hosts': 'Anfitriones',
    'footer.become_host': 'Hazte anfitrión',
    'footer.resources': 'Recursos',
    'footer.community': 'Comunidad',
    'footer.help_center': 'Centro de ayuda',
    'footer.accessibility': 'Accesibilidad',
    'footer.newsletter.title': 'Suscríbete a nuestro boletín',
    'footer.newsletter.subtitle': 'Recibe las últimas ofertas y novedades.',
  ...
  en: {
    ...
    'footer.lodgings': 'Lodgings',
    'footer.experiences': 'Experiences',
    'footer.zones': 'Areas we operate',
    'footer.hosts': 'Hosts',
    ...
    'footer.newsletter.subtitle': 'Get the latest offers and news.',
